...
# Program Purpose: This program reads a comme-delimited data file into a LIST of smaller lists.
#       The data for each student is appended toa  list with six data fields:
