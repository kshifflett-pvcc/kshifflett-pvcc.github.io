...
# Program Purpose: This Magic 8-Ball code uses a Python tuple since the user does not have the ability to change the 8-Ball answers.
#                  However, the program could have used a Python list instead of a tuple.
#                  NOTE: Tuples use paretheses; lists use square braces.
...
def main():
    ...
    while another_question:
        ...
        another_question = input("Would you like to ask me another question? (Y/N): ")
