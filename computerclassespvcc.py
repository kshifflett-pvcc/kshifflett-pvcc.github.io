...
def display_network_courses():
    ...
    print(dash_line)
    print("Number of requires courses   : " + str(num_net_req))
...
def process_info_courses():
    ...
    num_info_elect = len(network_elect)
...
def display_info_courses():
    ...
    print(dash_line)
    print("Number of requires courses   : " + str(num_info_req))
    print("Number of elective courses   : " + str(num_info_elect))
    print("Total number of Cert. courses: " + str(tot_info))
    print(dash_line)
    print("All Certificate courses: ")
    num = 1
